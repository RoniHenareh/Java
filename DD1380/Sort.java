...
// javac Sort.java && java Student
// java Sort

// class som representerar varje person
class Student implements Comparable<Student> { // Comparable låter oss jämföra student objekt
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (slutdatum.compareTo(datum) >= 0) { 
                ...
                // som vi lägger till i vår lista
                ar.add(obj);
        ...
        boolean ans = ar.isEmpty(); // är listan tom? True/False
        if (ans == false) {
