...
class Gameboard extends JPanel {
    ...
    private Icon[] icons = {
		new ImageIcon(getClass().getResource("rock.gif"), "rock"), 
		new ImageIcon(getClass().getResource("paper.gif"), "paper"),
		new ImageIcon(getClass().getResource("scissors.gif"), "scissors")
	};
